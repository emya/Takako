...
class RateRequester extends Component {
  state = {
    rating: 0,
  ...
  <div>
    ...
    <form onSubmit={this.submitFeedback}>
      ...
      <p class="user-name"> How would you rate the requester? </p>
...
const mapDispatchToProps = dispatch => {
  return {
    rateRequester: (requestId, rating, torimo_feedback) => {
      return dispatch(requests.rateRequester(
        requestId, rating, torimo_feedback
      ));
    },
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(RateRequester);
